  ...
  const deleteAccount = async () => {
    ...
    try {
      ...
      const fetching = await fetch(
        `${
          CTX.systemConfig?.am
        }account/user/delete/main/account/${backup.trim()}`,
        {
          method: 'DELETE',
          headers: {
      ...
      createThreeButtonAlert(
        'Your account is set to be deleted in 7 days. This means all your data will be permanently removed. To prevent this, please cancel your account before the deadline.',
      );
    } catch (error) {
  ...
  return (
    <>
          ...
          <View style={{...styles.anomodalView}}>
            <>
              ...
              <Text
                ...
                Deleting your account requires your backup code.
              </Text>
      ...
      <ScrollView
        ...
        <Text style={styles.personalInfo}>Good bye</Text>

        <Text style={styles.topText}>
          We're sorry to see you go, hope you had your best experience with us.
          BYE! It takes 7 days for the deletion to be finalized. However, you
          can cancel the deletion before then.
        </Text>
      </ScrollView>
      {error.length > 0 && (
        <Text
